...
SECRET_KEY = 'django-insecure-6156m3cqm348nm9!telx(^e1^*h7@fqn44+bo7spzrqs0pl-h+'
...
WSGI_APPLICATION = 'fuel_finder.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 20,   # You can change to 10, 50 etc.,
